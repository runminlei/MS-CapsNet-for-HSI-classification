...
cf = K.image_data_format() == '..'  # cf = False
useGPU = True
...
def PrimaryCap(inputs, dim_vector, n_channels, kernel_size, strides, padding):
    ...
    :return: output tensor, shape=[None, height, width, depth, num_capsule, dim_capsule]
    """

    output = layers.Conv2D(filters=dim_vector * n_channels, kernel_size=kernel_size, strides=strides,
    ...
    outputs = layers.Reshape(target_shape=[shape[1].value, shape[2].value, n_channels, dim_vector],)(output)
